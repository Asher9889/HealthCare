...
import { DoctorSection, FissureTreatment, LaparoscopySurgery, LaserSurgery, NoCostEmi, PatientHelp } from "./pages";
 ...
 // Patient Service
  {
    ...
    children: [
      ...
      { label: "Doctors Section", path: "/doctor-section", element: DoctorSection },
    ],
  },
