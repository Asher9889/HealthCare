...
const LaserCircumcisionInSpecialCity = () => {
    ...
    const faqs = [
        {
            id: "one",
            question: `What is the cost of laser circumcision surgery in ${city}?`,
            answer:
                `The cost of laser circumcision surgery in ${city} varies depending on factors like hospital type, surgeon experience, and technology used. At PureCheckup, you get transparent pricing and full cost guidance during consultation.`,
        },
        {
            id: "two",
        ...
        {
            id: "three",
            question: `Which healthcare provider offers the best laser circumcision at the best price in ${city}?`,
            answer:
                `PureCheckup provides ${city}’s leading laser circumcision treatments performed by expert urologists using advanced technology, with affordable all-inclusive packages and complete post-surgery care.`,
        },
        {
            id: "four",
    ...
    return (
        <>
            <ConditionHeroSection
                title={`Painless Laser Circumcision Surgery in ${city} | Safe, Stitch-Free & Affordable Treatment`}
            ...
            <ConditionInfo
                ...
                expertHeading={`Expert Laser Circumcision Surgery in ${city} – PureCheckup`}
                doctorName=""
            ...
            <section className="py-20">
                <ConditionCityWiseTreatment
                    treatmentName={`Laser Circumcision in ${city}`}
