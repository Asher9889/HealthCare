...
const seoConfig = {
  title: "Paraphimosis Treatment | Emergency Care – PureCheckup",
  description: "Immediate paraphimosis treatment by expert urologists. Safe care, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "paraphimosis treatment, foreskin emergency, penile swelling treatment, paraphimosis surgery",
  canonical: "https://purecheckup.com/treatment/paraphimosis/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of paraphimosis surgery treatment in India?",
    answer:
      "Costs vary depending on the procedure type, hospital, and complexity. Contact PureCheckup for a detailed consultation and personalized estimate.",
  },
  {
    id: "two",
  ...
  },
  {
    ...
    answer:
      "PureCheckup provides expert paraphimosis surgery with advanced technology, skilled surgeons, and comprehensive insurance support across India.",
  },
  {
    id: "four",
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="Get Expert Paraphimosis Surgery – Quick Relief, Complete Care"
      ...
      <ConditionInfo
        ...
        expertHeading={paraphimosisData.doctorName}
        doctorName=""
