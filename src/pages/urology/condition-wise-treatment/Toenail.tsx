...
const seoConfig = {
  title: "Ingrown Toenail Treatment | Painless Care – PureCheckup",
  description: "Permanent ingrown toenail treatment by specialists. Fast relief, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "ingrown toenail treatment, toenail surgery, nail avulsion, toenail removal",
  canonical: "https://purecheckup.com/treatment/ingrown-toenail/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of toenail removal surgery treatment in India?",
    answer:
      "The cost varies depending on the type of surgery, hospital, and location. PureCheckup helps you find the most affordable and expert care in your city.",
  },
  {
    id: "two",
  ...
  {
    id: "three",
    question: "Which healthcare service provider offers the best toenail removal treatment in India?",
    answer:
      "PureCheckup partners with top-rated hospitals and certified surgeons across India for safe, reliable, and affordable toenail removal surgery.",
  },
  {
    id: "four",
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="Say Goodbye to Pain: Expert Toenail Removal Surgery for Ingrown, Fungal & Damaged Nails"
      ...
      <ConditionInfo
        ...
        expertHeading={toenailRemovalData.doctorName}
        doctorName=""
