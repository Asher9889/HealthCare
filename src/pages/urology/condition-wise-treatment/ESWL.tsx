...
const seoConfig = {
  title: "ESWL Treatment for Kidney Stones – PureCheckup",
  description: "Non-invasive ESWL treatment for kidney stones. Break stones without surgery. No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "ESWL treatment, shock wave lithotripsy, ESWL for kidney stones, ESWL cost, stone breaking treatment",
  canonical: "https://purecheckup.com/treatment/eswl/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of ESWL treatment surgery in India?",
    answer: (
      <div className="text-(--text-primary) font-medium space-y-2">
        <p>
          The cost of ESWL surgery in India varies depending on the hospital, type of
  ...
  {
    id: "three",
    question: "Which healthcare provider offers the best ESWL treatment at the best price?",
    answer: (
      <div className="text-(--text-primary) font-medium space-y-2">
        <p>
          <strong>PureCheckup.com</strong> connects you with top kidney specialists and
          NABH-accredited hospitals across India, offering high-quality ESWL treatments
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="Advanced ESWL Treatment – Expert Kidney Stone Removal Surgery"
      ...
      <ConditionInfo
        ...
        expertHeading="Expert ESWL Treatment Surgery – PureCheckup"
        doctorName=""
