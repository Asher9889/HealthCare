...
const seoConfig = {
  title: "Balanitis Treatment | Penile Infection Care – PureCheckup",
  description: "Effective balanitis treatment by experienced specialists. Fast relief, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "balanitis treatment, penile infection treatment, foreskin inflammation, balanitis symptoms",
  canonical: "https://purecheckup.com/treatment/balanitis/",
};
