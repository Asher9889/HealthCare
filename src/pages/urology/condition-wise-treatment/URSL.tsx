...
const seoConfig = {
  title: "URSL Surgery for Ureter Stones – PureCheckup",
  description: "Effective URSL surgery for ureter stone removal. Advanced laser treatment, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "URSL surgery, ureter stone treatment, URSL laser surgery, ureter stone removal",
  canonical: "https://purecheckup.com/treatment/ursl/",
};
