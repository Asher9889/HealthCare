...
const seoConfig = {
  title: "Laser Circumcision Treatment | Safe Surgery – PureCheckup",
  description: "Get advanced laser circumcision with expert doctors. Safe, painless procedure with No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "laser circumcision surgery, painless circumcision, laser circumcision cost, circumcision recovery, circumcision treatment, circumcision near me",
  canonical: "https://purecheckup.com/treatment/laser-circumcision/",
};
