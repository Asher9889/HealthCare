...
const seoConfig = {
  title: "Epididymal Cyst Treatment | Safe Removal – PureCheckup",
  description: "Effective epididymal cyst treatment and removal. Minimal pain, fast recovery, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "epididymal cyst treatment, spermatocele removal, scrotal cyst surgery, epididymal cyst symptoms",
  canonical: "https://purecheckup.com/treatment/epididymal-cyst/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of epididymal cyst surgery treatment in India?",
    answer:
      "The cost varies depending on hospital, city, and surgical type. PureCheckup provides affordable, transparent pricing without compromising quality.",
  },
  {
    id: "two",
  ...
  {
    id: "three",
    question: "Which healthcare service provider offers the best treatment at a reasonable price?",
    answer:
      "PureCheckup partners with top-rated urologists and multi-specialty hospitals across India to deliver expert care at the best value.",
  },
  {
    id: "four",
...
const EpididymalCyst = () => {
  return (
    <>
      <SEO {...seoConfig} />
      <ConditionHeroSection
        title="Advanced & Painless Epididymal Cyst Surgery in India | Quick Recovery & Expert Urologists"
      ...
      <ConditionInfo
        ...
        expertHeading={epididymalCystData.doctorName}
        doctorName=""
