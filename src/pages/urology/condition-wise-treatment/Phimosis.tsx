...
const seoConfig = {
  title: "Phimosis Treatment | Laser Surgery – PureCheckup",
  description: "Advanced phimosis treatment with laser surgery. Fast recovery, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "phimosis treatment, phimosis surgery, tight foreskin, laser circumcision",
  canonical: "https://purecheckup.com/treatment/phimosis/",
};
