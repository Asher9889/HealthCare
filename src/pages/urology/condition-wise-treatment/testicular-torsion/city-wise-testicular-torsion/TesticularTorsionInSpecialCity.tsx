...
const TesticularTorsionInSpecialCity = () => {
    ...
    const faqs = [
        {
            id: "one",
            question: `What is the cost of testicular torsion surgery treatment in ${city}?`,
            answer:
                `The cost in ${city} depends on hospital location, surgeon expertise, and procedure type. PureCheckup ensures affordable, transparent pricing with detailed breakdowns.`,
        },
        {
            id: "two",
        ...
        {
            id: "three",
            question: `Which healthcare service provider offers the best treatment for testicular torsion in ${city}?`,
            answer:
                `PureCheckup partners with experienced urologists and NABH-accredited hospitals in ${city} to deliver high-quality, precise, and painless testicular torsion surgeries.`,
        },
        {
            id: "four",
    ...
    return (
        <>
            <ConditionHeroSection
                title={`Advanced Testicular Torsion Treatment in ${city} – Quick Pain Relief & Faster Recovery`}
            ...
            <ConditionInfo
                ...
                expertHeading={`Expert Testicular Torsion Surgery in ${city} – PureCheckup`}
                doctorName=""
            ...
            <section className="py-20">
                <ConditionCityWiseTreatment
                    treatmentName={`Testicular Torsion in ${city}`}
