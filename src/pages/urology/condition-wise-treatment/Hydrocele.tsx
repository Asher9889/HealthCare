...
const seoConfig = {
  title: "Hydrocele Treatment | Painless Surgery – PureCheckup",
  description: "Safe hydrocele treatment with advanced surgical care. Experienced surgeons, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "hydrocele treatment, hydrocele surgery, hydrocele operation cost, hydrocele symptoms, scrotal swelling treatment",
  canonical: "https://purecheckup.com/treatment/hydrocele/",
};
