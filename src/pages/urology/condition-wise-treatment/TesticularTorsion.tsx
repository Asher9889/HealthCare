...
const seoConfig = {
  title: "Testicular Torsion Treatment | Emergency Care – PureCheckup",
  description: "Immediate testicular torsion treatment by expert urologists. Save the testis, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "testicular torsion treatment, twisted testicle surgery, testicular emergency, scrotal pain treatment",
  canonical: "https://purecheckup.com/treatment/testicular-torsion/",
};
