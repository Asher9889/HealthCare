...
const seoConfig = {
  title: "Corn Removal Treatment | Painless Care – PureCheckup",
  description: "Quick and painless corn removal treatment by specialists. No-Cost EMI & Free Consultation available at PureCheckup.",
  keywords: "corn removal treatment, foot corn removal, corn surgery, corn removal laser",
  canonical: "https://purecheckup.com/treatment/corn-removal/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of corn removal surgery treatment in India?",
    answer:
      "The cost depends on the type of surgery, severity of the condition, and city. PureCheckup provides an estimated quote after a free consultation.",
  },
  {
    id: "two",
  ...
  },
  {
    ...
    answer:
      "PureCheckup partners with top hospitals and certified foot surgeons in India to provide safe, affordable, and advanced corn removal treatments.",
  },
  {
    id: "four",
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="Advanced Corn Removal Surgery – Safe, Painless & Permanent Solution"
      ...
      <ConditionInfo
        ...
        expertHeading={cornRemovalData.doctorName}
        doctorName=""
