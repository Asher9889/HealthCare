...
const URSLInSpecialCity = () => {
    ...
    const faqs = [
        {
            id: "one",
            question: `What is the cost of URSL treatment surgery in ${city}?`,
            answer:
                `The cost of URSL surgery in ${city} varies depending on the hospital, type of surgery, and stone complexity. Contact PureCheckup for a personalized consultation and cost estimate.`,
        },
        {
            id: "two",
        ...
        {
            id: "three",
            question: `Which healthcare service provider provides the best URSL treatment at the best price in ${city}?`,
            answer:
                `PureCheckup partners with top hospitals and experienced urologists across ${city} to ensure high-quality, safe, and affordable URSL treatment.`,
        },
        {
            id: "four",
    ...
    return (
        <>
            <ConditionHeroSection
                title={`URSL Surgery in ${city} - Expert Ureteroscopy & Stone Removal Treatment`}
            ...
            <ConditionInfo
                ...
                expertHeading={`Expert URSL Treatment Surgery in ${city} – PureCheckup`}
                doctorName=""
