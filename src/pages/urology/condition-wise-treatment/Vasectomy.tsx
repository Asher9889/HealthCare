...
const seoConfig = {
  title: "No-Scalpel Vasectomy Surgery – PureCheckup",
  description: "Safe and effective no-scalpel vasectomy surgery. Quick recovery, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "vasectomy surgery, no-scalpel vasectomy, male sterilization, vasectomy treatment",
  canonical: "https://purecheckup.com/treatment/vasectomy/",
};
