...
const seoConfig = {
  title: "PCNL Surgery for Large Kidney Stones – PureCheckup",
  description: "PCNL surgery for large kidney stones by expert urologists. Safe care, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "PCNL surgery, PCNL kidney stone treatment, percutaneous nephrolithotomy, kidney stone removal surgery",
  canonical: "https://purecheckup.com/treatment/pcnl/",
};
