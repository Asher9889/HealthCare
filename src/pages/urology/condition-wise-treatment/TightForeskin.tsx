...
const seoConfig = {
  title: "Tight Foreskin Treatment | Painless Care – PureCheckup",
  description: "Effective tight foreskin treatment including laser procedures. Safe care, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "tight foreskin treatment, phimosis treatment, foreskin problem, circumcision surgery",
  canonical: "https://purecheckup.com/treatment/tight-foreskin/",
};
