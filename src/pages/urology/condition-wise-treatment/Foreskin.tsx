...
const seoConfig = {
  title: "Foreskin Infection Treatment | Expert Care – PureCheckup",
  description: "Complete foreskin infection treatment with advanced care. Quick relief, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "foreskin infection treatment, penile infection, foreskin inflammation, balanitis treatment",
  canonical: "https://purecheckup.com/treatment/foreskin-infection/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of foreskin infection surgery treatment in India?",
    answer:
      "Costs vary depending on the procedure type, hospital, and patient requirements. PureCheckup provides personalized quotes after consultation.",
  },
  {
    id: "two",
  ...
  },
  {
    ...
    answer:
      "PureCheckup is recognized across India for safe, cost-effective, and advanced foreskin infection treatment performed by expert surgeons.",
  },
  {
    id: "four",
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="Expert Foreskin Infection Surgery – Quick, Comfortable & Advanced Treatment"
      ...
      <ConditionInfo
        ...
        expertHeading={foreskinInfectionData.doctorName}
        doctorName=""
