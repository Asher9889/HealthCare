...
const seoConfig = {
  title: "RIRS Surgery for Kidney Stones – PureCheckup",
  description: "Advanced RIRS surgery for kidney stone removal. Minimal pain, fast recovery, No-Cost EMI & Free Consultation at PureCheckup.",
  keywords: "RIRS surgery, RIRS kidney stone treatment, laser kidney stone surgery, flexible ureteroscopy",
  canonical: "https://purecheckup.com/treatment/rirs/",
};
...
const faqs = [
  {
    id: "one",
    question: "What is the cost of RIRS surgery in India?",
    answer:
      "The cost of RIRS surgery in India typically ranges between ₹80,000 and ₹1,00,000, depending on the hospital, city, and complexity of kidney stones. PureCheckup offers transparent pricing and helps patients choose affordable, high-quality treatment options.",
  },
  {
    id: "two",
  ...
  {
    id: "three",
    question: "Which healthcare provider offers the best RIRS treatment in India?",
    answer:
      "PureCheckup connects patients with India’s top hospitals and urologists specializing in RIRS. Our partnered healthcare centers provide advanced laser technology, expert surgeons, and complete insurance support at competitive prices.",
  },
  {
    id: "four",
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="RIRS Surgery in India – Advanced Kidney Stone Treatment"
      ...
      <ConditionInfo
        ...
        expertHeading="Expert RIRS Surgery – PureCheckup"
        doctorName=""
