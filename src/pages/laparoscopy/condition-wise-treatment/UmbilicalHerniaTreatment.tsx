...
const faqs = [
  {
    id: "one",
    question: "What is the cost of Umbilical Hernia surgery in India?",
    answer:
      "The cost of umbilical hernia surgery in India varies depending on the city, hospital, surgeon’s expertise, and whether it’s an open or laparoscopic procedure. PureCheckup’s experts provide a personalized cost plan based on your needs and location.",
  },
  {
    id: "two",
    question: "Does insurance cover Umbilical Hernia surgery treatment?",
    answer:
  ...
  },
  {
    ...
    answer:
      "PureCheckup partners with India’s top hospitals and expert hernia surgeons to provide affordable and advanced umbilical hernia treatment with transparent pricing, EMI options, and insurance support.",
  },
  {
    id: "four",
  ...
  {
    id: "ten",
    question: "Why choose PureCheckup for Umbilical Hernia Surgery?",
    answer: (
      <div className="text-(--text-primary) font-medium space-y-2">
        <ul className="list-disc list-inside space-y-1">
          <li>Network of expert surgeons & NABH-accredited hospitals</li>
...
const UmbilicalHerniaTreatment = () => {

  const seoData = {
    title: "Get Free Umbilical Hernia Consult @9211930749 | PureCheckup",
    description: "Advanced umbilical hernia surgery at PureCheckup. Safe laparoscopic repair by top surgeons. Call @9211930749 for expert hernia treatment today.",
    keywords: "hernia repair umbilical, laparoscopic umbilical hernia, umbilical hernia doctor, best umbilical hernia hospital, hernia operation near me, safe umbilical hernia surgery, umbilical hernia treatment india, minimally invasive hernia surgery, advanced hernia care",
    canonical: "https://purecheckup.com/treatment/umbilical-hernia/",
  }
  ...
  return (
    <>
      ...
      <ConditionHeroSection
        title="Umbilical Hernia Surgery – Cost, Procedure, Recovery & Expert Care"
...
export default UmbilicalHerniaTreatment;