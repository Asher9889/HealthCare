...
const seoConfig = {
  title: "Free Laser Surgery Fissure Consult @9211930749 | PureCheckup",
  description: "Get expert fissure treatment with advanced laser surgery at PureCheckup. Safe, painless care by top proctologists. Call @9211930749 now!",
  keywords: "fissure treatment, fissure surgery, piles fissure laser treatment, laser fissure surgery, fissure doctor near me, anorectal fissure care, fissure pain relief, proctology treatment, no cost emi fissure treatment, best fissure clinic in india",
...
export const faqs = [
  {
    id: "one",
    question: "What is the cost of fissure surgery in India?",
    answer:
      "The cost varies based on the procedure type and hospital. Laser fissure surgery typically ranges from ₹55,000 to ₹91,800, while open surgery costs between ₹30,000 and ₹45,000.",
  },
  {
    id: "two",
  ...
  },
  {
    id: "three",
    question:
      "Which healthcare service provider offers the best fissure treatment at the best price?",
    answer:
      "PureCheckup collaborates with India’s leading hospitals and experienced proctologists to provide affordable, high-quality fissure treatment with complete care support.",
  },
  {
    id: "four",
...
const FissureTreatment = () => {
  return (
    <>
      <SEO {...seoConfig} />
      <ConditionHeroSection
        title="Expert Anal Fissure Treatment & Surgery – Safe, Advanced & Affordable"
...
export default FissureTreatment;