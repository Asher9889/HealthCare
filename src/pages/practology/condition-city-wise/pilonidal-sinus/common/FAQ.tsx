interface FAQProps {
  ...
  const FAQ: React.FC<FAQProps> = ({ city }) => {
    const faqs = [
      {
        id: "one",
        question: `What is the cost of Pilonidal Sinus treatment in ${city}?`,
        answer: (
          <div className="text-(--text-primary) font-medium space-y-2">
            <p>
              The cost of Pilonidal Sinus treatment in {city} at PureCheckup depends on the
              severity and type of treatment recommended. Laser treatment is a painless,
              minimally invasive, and highly effective option offered at affordable prices
              with EMI support.
            </p>
            <p>
      ...
      {
        id: "two",
        question: `Who is the best doctor for Pilonidal Sinus treatment in ${city}?`,
        answer: (
          <div className="text-(--text-primary) font-medium space-y-2">
            <p>
              PureCheckup connects you with experienced colorectal and proctology specialists
              in {city}, including Dr. Tanmay Jain, who are experts in advanced laser Pilonidal
              Sinus treatments with high success rates.
            </p>
            <p>
      ...
      {
        id: "three",
        question: `Is laser Pilonidal Sinus treatment available in ${city} at PureCheckup?`,
        answer: (
          <div className="text-(--text-primary) font-medium space-y-2">
            <p>
              Yes, PureCheckup provides advanced laser-assisted Pilonidal Sinus treatment in
              {city}. The procedure is safe, minimally invasive, and ensures faster healing
      ...
      {
        id: "four",
        question: `How long does it take to recover after Pilonidal Sinus treatment in ${city}?`,
        answer: (
          <div className="text-(--text-primary) font-medium space-y-2">
            <p>
              With laser Pilonidal Sinus treatment, most patients resume normal activities
              within 1–2 days. Complete healing usually takes 2–4 weeks, depending on the
              condition.
            </p>
            <p>
      ...
      {
        id: "five",
        question: `Why choose PureCheckup for Pilonidal Sinus treatment in ${city}?`,
        answer: (
          <div className="text-(--text-primary) font-medium space-y-2">
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Free consultation and dedicated post-treatment care</li>
            </ul>
            <p>
