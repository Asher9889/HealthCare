		...
		<section className="relative w-full px-4 pt-10 pb-20">
			<div className="mx-auto max-w-5xl space-y-8">
				<div className="flex flex-col gap-2">
					<h1 className="text-balance text-(--text-primary) font-semibold text-3xl tracking-wide md:text-2xl lg:text-3xl xl:font-bold">
				...
				<div className="relative grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
					{testimonials.map(({ name, designation, quote, stars }, index) => (
						<motion.div
						...
						>
							...
							<div>
								<div className="-mt-0.5 -space-y-0.5">
									<div className="z-10 flex flex-row justify-start items-center">
										<p className="text-sm md:text-base mr-3">{name}</p> 
										<StarRating name={`rating-${index}`} value={stars} />
									</div>
